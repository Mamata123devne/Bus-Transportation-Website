...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>College Bus and Ticket Booking</title>
   ...
   <!-- <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">-->
    ...
    <style type="text/css">
      ...
      body{
          ...
          background-image: url(https://www.trinityglobalschool.com/wp-content/uploads/2021/10/In-House-Transport.jpg);
...
.btnHome:hover{
  ...
  <div id="container">
            ...
            <?php include("nav.php");
             ?>
                  ...
                  <h1 class="home_details">Welcome To KJEI Bus.<br><font class="font">The Bus Of EveryOnes..</font>
 ...
 <div class="section">
                      ...
                      <video autoplay loop muted class="section">
                                  ...
                                  <source src="/ticket booking/Busbooking/video/bus.mp4" type="video/mp4">
